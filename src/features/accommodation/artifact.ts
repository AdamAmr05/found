/**
 * Provisional product artifact and shared prototype fixtures. This is the one
 * object expressed by the composed card, Fold, and Merge. It is intentionally
 * a presentation contract rather than a proposed database schema.
 */
...
export interface AccommodationArtifact {
...
export const accommodations: readonly AccommodationArtifact[] = [
  {
    id: 'maybachufer',
  ...
  },
  {
    ...
    imageUrls: [
      ...
      photo('photo-1560185127-6ed189bf02f4'),
      photo('photo-1524758631624-e2822e304c36'),
    ],
  ...
  },
  {
    ...
    imageUrls: [
      ...
      photo('photo-1560185007-c5ca9d2c014d'),
    ],
  ...
  },
  {
    ...
    imageUrls: [
      photo('photo-1560448204-e02f11c3d0e2'),
      photo('photo-1560184897-ae75f418493e'),
      photo('photo-1560185008-b033106af5c3'),
    ],
...
export function getAccommodation(id: AccommodationId): AccommodationArtifact {
  const candidate = accommodations.find((entry) => entry.id === id)
...
export function tallyClaims(candidate: AccommodationArtifact): ClaimTally {
