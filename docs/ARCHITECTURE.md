...
| OpenAI through the Convex AI Gateway | Reasoning over evidence, choosing tools, resolving the user's intent, and emitting validated render parts and layout operations                    | Executable UI code or durable state                     |
